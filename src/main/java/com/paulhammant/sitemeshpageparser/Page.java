...
package com.paulhammant.sitemeshpageparser;
 ...
 * different {@link PageParser} implementations.</p>
 *
 * <p>Typically a Page is no use to a {@link Decorator} as it needs
 * specific details relevant to the content-type of that page (<i>e.g.</i> HTML
 * pages). The appropriate {@link PageParser} is responsible
 * for returning extended implementations of pages such as {@link HTMLPage}
